...
PROTOBUF_NAMESPACE_OPEN
template <>
::Krpc::RpcHeader* Arena::CreateMaybeMessage<::Krpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Krpc {

// ===================================================================

class RpcHeader PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Krpc.RpcHeader)
                                                                          */
{
public:
    ...
    RpcHeader(RpcHeader&& from) noexcept : RpcHeader() {
        *this = ::std::move(from);
    }
...
public:
    ...
    GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
        ...
        "    string fields are deprecated and will be removed in a"
        "    future release.")
    void unsafe_arena_set_allocated_service_name(std::string* service_name);
...
public:
    ...
    GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
        ...
        "    string fields are deprecated and will be removed in a"
        "    future release.")
    void unsafe_arena_set_allocated_method_name(std::string* method_name);
...
inline std::string* RpcHeader::unsafe_arena_release_service_name() {
    ...
    return service_name_.UnsafeArenaRelease(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        GetArena());
}
inline void RpcHeader::unsafe_arena_set_allocated_service_name(
    ...
    service_name_.UnsafeArenaSetAllocated(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        service_name, GetArena());
...
inline std::string* RpcHeader::unsafe_arena_release_method_name() {
    ...
    return method_name_.UnsafeArenaRelease(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        GetArena());
}
inline void RpcHeader::unsafe_arena_set_allocated_method_name(
    ...
    method_name_.UnsafeArenaSetAllocated(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        method_name, GetArena());
...
// uint32 args_size = 3;
inline void RpcHeader::clear_args_size() { args_size_ = 0u; }
...
inline void RpcHeader::_internal_set_args_size(
